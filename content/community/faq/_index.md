...
Email us at `info@openforcefield.org` or reach out to one of our current [Primary Investigators](/about/team/) if you're interested in joining as an investigator.
{{< br >}}{{< br >}}
...
The Open Force Field Consortium is an industry-funded effort to develop small molecule force fields. We are continuously seeking different sources of funding (federal, philanthropic, industry) to broaden this effort in collaboration with other scientists.
{{< br >}}{{< br >}}
...
Yes! Everything is open source under permissive licenses (generally the MIT License). We are also open to suggestions from the community, as well as community input on the codes and research directions. Please contribute to our GitHub issue trackers for projects at https://github.com/openforcefield, or even feel free to contribute code if you find it useful!
...
See our [research roadmap](/science/research/) for an overview of the most important past and future milestones.
{{< br >}}{{< br >}}
